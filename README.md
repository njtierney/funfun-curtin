...
# Slide available [here](https://njtierney.github.io/funfun-curtin/#/title-slide)
...
Dr. Nicholas Tierney (PhD. Statistics, BPsySci (Honours)) is a consultant research software engineer and statistician.

Previously, he worked with with [Nick Golding](https://www.telethonkids.org.au/contact-us/our-people/g/nick-golding/) at the [The Kids Research Institute Australia](https://www.thekids.org.au/), in Perth, Western Australia, where he worked on improving and maintaining the [greta](https://greta-stats.org/) R package for statistical modelling, and implementing workflows to automate analysis on diseases like COVID19 and malaria. He was previously (2017-2020) a Research Fellow, then Lecturer in Business Analytics and Statistics at Monash University, working with Professors
[Dianne Cook](http://dicook.org/) and [Rob Hyndman](https://robjhyndman.com/).

His research was on improving data analysis
workflow, and making data analysis more accessible. Crucial to this work is producing high quality software to
accompany each research idea. Nick's work has focussed on exploring longitudinal data ([brolgar](http://brolgar.njtierney.com/)), and improving how we share data alongside research ( [ddd](https://github.com/karthik/ddd)). Other work has focussed on exploring data
